...
import 'package:todoo/login/login.dart';
import 'package:todoo/signup/repository/signup_repo.dart';

import '../../login Details/view/login_details_page.dart';
          ...
          child: Column(
            children: [
              ...
              signupDetails(
                ...
                controller: _textEditingNumberController,
                validator: (value) {
                  if (value!.isEmpty) {
                    return "Please fill this field";
                  }
